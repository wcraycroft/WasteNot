...
public class ClaimsAdapter extends RecyclerView.Adapter<ClaimsAdapter.ItemHolder> {
    ...
    private ArrayList<Claim> allClaims;
     ...
     */
    public ClaimsAdapter(Activity mActivity, ArrayList<Claim> allClaims, OnItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        Claim claim = allClaims.get(position);
        if (claim != null) {
            holder.tvCompanyName.setText(claim.getDonor().getCompanyName());
            holder.tvDropOffEndTime.setText(claim.getDropOffEndTime());
